...
export default function Rewards() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      {/* centered container: prevents content from stretching full width */}
      <div className="max-w-7xl mx-auto px-4">
        {/* header */}
        <div className="mb-6">
          <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 flex items-center gap-3">
            <Icons.Gift className="text-indigo-600" size={26} />
            Rewards Management
          </h1>
        ...
        <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="flex items-center gap-3">
            <motion.button
              ...
              className="inline-flex items-center gap-2 bg-indigo-600 text-white px-3 md:px-4 py-2 rounded-lg shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-200 text-sm"
            ...
            <motion.button
              ...
              className="inline-flex items-center gap-2 bg-white border px-3 py-2 rounded-lg hover:bg-gray-50 focus:outline-none text-sm"
        ...
        {/* Content: keep grid inside container; cards have fixed padding and max height so they don't overflow */}
        <div>
          {loading ? (
              ...
              <AnimatePresence>
                {rewards.map((r) => {
                  ...
                  return (
                    <motion.article
                      key={r.docId}
                      className="bg-white rounded-xl shadow p-4 flex flex-col max-h-[420px] overflow-hidden"
                      variants={card}
                      whileHover="hover"
                      layout
                      initial="hidden"
